    ...
    <div className="h-full bg-primary/30 py-36 flex items-center">
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-x-8">
          {/* text */}
          <div className="text-center flex xl:w-[20vw] flex-col lg:text-left mb-4
          xl:mb-0">
            <motion.h2 variants={fadeIn('up', 0.2)} initial="hidden" animate="show"
            exit="hidden" className="h2 xl:mt-12 ">
            ...
            exit="hidden" className="mb-4 max-w-[400px] mx-auto lg:mx-0">
              ...
              varius ex ut ex dictum, sit amet luctus enim fermentum. Aenean
              faucibus, felis nec ultricies.
            </motion.p>
          </div>
          {/* Slider */}
